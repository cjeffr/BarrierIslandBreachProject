...
def setgeo(rundata):
    ...
    # the smaller domains
    topo_data.topofiles.append([4,  './gebco_2020_n45.0_s8.0_w-88.0_e-50.0.nc'])
    topo_data.topofiles.append([4, './gebco_2021_n50.0_s21.0_w-90.0_e-55.0.nc'])
    topo_data.topofiles.append([4, './gebco_2021_n53.0_s5.0_w-100.0_e-50.0.nc '])
