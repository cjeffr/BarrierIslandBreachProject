...
ocean_topo = topotools.Topography(path='../bathymetry/gebco_atlantic.asc', topo_type=3)
island_topo = topotools.read_netcdf(path='../bathymetry/moriches.nc')
ocean_topo.plot()
...
extent = [-72.615,-72.375,40.79,40.900]
...
fname_fgmax_mask = 'fgmax_pts_moriches.data'
